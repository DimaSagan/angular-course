...
export const routes: Routes = [
    ...
    {path: 'home', resolve:{data: HomePageResolver}, loadComponent:()=>import('./pages/home-page/home-page.component').then(m=>m.HomePageComponent), canDeactivate:[canDeactivateGuard]},
    ...
    {path: 'movie/:id', resolve: { data: MovieResolver }, loadComponent:()=>import('./pages/movie-details-page/movie-details-page.component').then(m=>m.MovieDetailsPageComponent), canDeactivate:[canDeactivateGuard]},
